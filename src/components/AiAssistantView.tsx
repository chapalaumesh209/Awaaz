...
export const AiAssistantView: React.FC<AiAssistantViewProps> = ({ currentLanguage }) => {
  ...
  const [messages, setMessages] = useState<{ sender: 'citizen' | 'ai'; text: string; timestamp: string }[]>([
    {
      sender: 'ai',
      text: t.botWelcome || "Namaste! I am HaqSetu AI, your universal multilingual voice companion. I can help explain complex scheme details, guide your missing documents checklist, or draft official panchayat grievance petitions. Ask me anything!",
  ...
  useEffect(() => {
    ...
    const welcomeText = t.botWelcome || "Namaste! I am HaqSetu AI, your universal multilingual companion. Ask me anything!";
    setMessages(prev => {
      if (prev.length === 0) {
        return [{
          sender: 'ai',
